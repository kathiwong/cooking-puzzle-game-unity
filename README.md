# cooking-puzzle-game-unity
	
This project aims to design and develop a hybrid-casual game prototype from scratch that combines puzzle mechanics with restaurant simulation elements to provide players with an engaging gameplay that combines the logical challenge of puzzle-solving and the time constraints that restaurant simulation games feature. Inspired by tile-merging puzzle games and restaurant games, the base game requires players to fulfil timed customer orders while strategically managing limited board space.
